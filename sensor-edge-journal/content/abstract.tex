...
\author{
	...
	\uppercase{Udo A. Ernst}\authorrefmark{4},
	\uppercase{Amir Najaf}\authorrefmark{5},
	\uppercase{Ardalan Najaf}\authorrefmark{6},
	\uppercase{Karl-Ludwig Krieger}\authorrefmark{7},
	\uppercase{Klaus R. Pawelzik}\authorrefmark{8},
	\uppercase{Alberto Garcia-Ortiz}\authorrefmark{9} \IEEEmembership{Member, IEEE},
}
